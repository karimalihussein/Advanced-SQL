...
insert into employees(name,phone,salary) values('John','1234567890',1000, 'TX');
insert into employees(name,phone,salary) values('Mary','1234567891',2000, 'NY');
insert into employees(name,phone,salary) values('Steve','1234567892',3000, 'NW');
insert into employees(name,phone,salary) values('Bill','1234567893',4000, 'CA');
insert into employees(name,phone,salary) values('Ram','1234567894',5000, 'TX');
insert into employees(name,phone,salary) values('Ron','1234567895',6000, 'TX');
...
-- union
select name, phone, salary from employees where state = 'CA'
union
select name, phone, salary from customers where state = 'CA';
