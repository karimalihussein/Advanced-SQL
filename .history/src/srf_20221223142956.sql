...
-- using truncate   
select name, price, truncate(price, 1) from products; 

-- using mod
select name, price, mod(price, 10) from products;
-- using mod inside round
select name, price, round(price, mod(price, 10)) from products;
