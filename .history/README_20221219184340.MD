...
- First generation database is a database that is not relational.
- First generation database is also known as a flat file database.
* Features of first generation database: 
- first version 
