...
insert into customers(name,phone,state) values('John','1234567890','CA');
insert into customers(name,phone,state) values('Mary','1234567891','NY');
insert into customers(name,phone,state) values('Steve','1234567892','TX');
insert into customers(name,phone,state) values('Bill','1234567893','CA');
insert into customers(name,phone,state) values('Ram','1234567894','NY');
insert into customers(name,phone,state) values('Ron','1234567895','TX');
